...
##$FarmScriptUrl = 'http://tinkle/dev/php/pmwiki/pmwiki.php';
#$FarmPubDirUrl = 'http://tinkle/dev/php/pmwiki/pub';
$FarmPubDirUrl = 'http://www.hexerei.net/xox/bin/pmwiki/pub';
...
##$ScriptUrl = 'http://tinkle/dev/php/pmwiki/pmwiki.php';
#$PubDirUrl = 'http://tinkle/dev/php/pmwiki/pub';
$PubDirUrl = 'http://www.hexerei.net/xox/bin/pmwiki/pub';
...
$PageLogoUrl = "$PubDirUrl/skins/hexerei/shexerei.gif";
...
$DefaultPasswords['admin'] = crypt('vops2233');
...
$EnableUpload = 1;
$DefaultPasswords['upload'] = crypt('vops22');
